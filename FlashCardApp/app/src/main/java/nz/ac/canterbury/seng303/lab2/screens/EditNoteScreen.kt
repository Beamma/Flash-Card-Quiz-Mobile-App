...
//    val selectedNoteState by flashRepository.selectedFlashCard.collectAsState(null)
//    val note: FlashCard? = selectedNoteState // we explicitly assign to note to help the compilers smart cast out
//
